...
public class PresenceManager {
    ...
    public void tick(net.minecraft.client.MinecraftClient client) {
        if (client.player != null) {
            ...
            if (currentX != lastX || currentY != lastY || currentZ != lastZ || currentYaw != lastYaw
                ...
                me.orbitium.nortix.client.util.IdleTracker.recordActivity();
                lastX = currentX;
                lastY = currentY;
                lastZ = currentZ;
                lastYaw = currentYaw;
        ...
        boolean idleNow = me.orbitium.nortix.client.util.IdleTracker.isIdle();
    ...
    private void updateDiscordRPC() {
        ...
        if (shouldShow) {
            ...
            me.orbitium.nortix.client.util.DiscordRPCManager.clearActivity();
        }
    }
