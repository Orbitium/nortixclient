    ...
    private void sendHeartbeat() {
        ...
        sessionManager.getAccessToken()
                .thenCompose(accessToken -> {
                    ...
                    me.orbitium.craftcorpsCosmetics.client.api.AuthApiClient.HeartbeatPayload payload = new me.orbitium.craftcorpsCosmetics.client.api.AuthApiClient.HeartbeatPayload(
                    ...
                    if (result.sessionExpired) {
                        ...
                        if (result.cosmeticsVersion != null) {
                            if (currentCosmeticsVersion == null) {
                                ...
                                me.orbitium.craftcorpsCosmetics.client.CapeManager.refreshLocalPlayer();
                            }
                        }
                        ...
                        if (result.updatedUuids != null && !result.updatedUuids.isEmpty()) {
                            ...
                            for (String uuidStr : result.updatedUuids) {
                                try {
                                    ...
                                    me.orbitium.craftcorpsCosmetics.client.CapeManager.refreshPlayer(u);
                        ...
                        if (result.ttl != null) {
                            me.orbitium.craftcorpsCosmetics.client.CapeManager.setCacheTtl(result.ttl);
                        }
                    } else {
